...
if __name__ == '__main__':
	...
	for i in dayList:
		...
		inputPath = "/RED1BDATA_A/SNR/XWW/file/Amer_West/3B/%s/Band9/"%i
		print inputPath
		...
		# f = "/RED1BDATA/FIXSITE/SNR/MERSI/AllRegionValidRef/2015ceshi/2015/v6/validRefFactor/20150610/Band9/20150610_1550_validRefFactor_Band9.HDF"
			...
			for ds in dateset:
				...
				savePath = "/RED1BDATA_A/SNR/XWW/file/Amer_West/Pic/%s/"%i
				...
				# if ds == "noise_refFactor":
					main(f, "/FYDISK/DATA/FY3/FY3B/MERSI/L1/1000M/2015/%s/FY3B_MERSI_GBAL_L1_%s_1000M_MS.HDF"%(i,YMD_HM),savePath + "%s_%s_1111noise%s.png" %(YMD_HM,ds,noise_th),ds)
